...
Computer Vision과 AI에 관심이 많고, 특히 **Vision-Language Model(VLM)**, **3D Pose Estimation**, **영상 기반 동작 분석** 분야를 깊이 파고들고 있습니다. 모델을 만드는 것에 그치지 않고 **실제 서비스에 적용해 운영까지 해본 경험**이 강점입니다.
