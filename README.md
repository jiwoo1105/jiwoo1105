...
카메라 영상 하나로 사람의 자세를 추정하고, 움직임을 수치로 바꿔서 분석하는 게 요즘 가장 재밌는 주제입니다. 축구 드리블 동작을 자동으로 평가하는 시스템을 만들기도 했고, YOLO 기반 객체 탐지 파이프라인도 직접 설계해 봤습니다.

백엔드 경험도 있습니다. **Redis + Kafka 기반 티켓팅 시스템**을 설계해서 실제 대학 축제에서 4,500명 동시접속 환경으로 운영했습니다.
