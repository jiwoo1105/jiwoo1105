...
**Computer Vision**과 **AI** 쪽에 관심이 많고, 그 중에서도 **3D Pose Estimation**, **VLM**, **영상 기반 동작 분석**을 주로 파고 있습니다.

코드만 짜는 게 아니라 실제로 배포하고 사람들이 쓰는 걸 보는 게 좋아서, 대학 축제 때 직접 만든 앱을 **4,500명이 동시에 접속**하는 환경에서 운영해 본 적도 있습니다.
