...
| **MedGuard** | 2026.02 – 2026.06 | **의료영상 적대적 공격 분석 및 방어** 시스템 <br> FFT 주파수 분석으로 공격 유형(FGSM/PGD/DiffAttack) 자동 분류 <br> **RoentGen VAE 기반 Medical DiffPure** 의료 특화 정화 파이프라인 <br> CheXpert 흉부 X-ray **38,765장** 학습 | Python, PyTorch, Stable Diffusion, Gradio, TorchXRayVision | Robust Acc: FGSM 58.31%, PGD 61.47%, DiffAttack **78.56%** <br> 전 공격 유형 최고 방어율 달성 <br> [GitHub](https://github.com/jiwoo1105/AISecurity) |
